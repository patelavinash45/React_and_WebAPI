...
public class Authorization : Attribute, IAuthorizationFilter
{
    public void OnAuthorization(AuthorizationFilterContext context)
    {
        ...
        {
            context.Result = new BadRequestObjectResult(HelperClass.ManageBadRequest("Authorization header missing"));
            return;
        }
        else
        {
            ...
            {
                context.Result = new BadRequestObjectResult(HelperClass.ManageBadRequest("Authorization Token Is Invalid."));
                return;
            }
        }
    }
